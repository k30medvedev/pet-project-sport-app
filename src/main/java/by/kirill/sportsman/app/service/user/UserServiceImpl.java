...
import by.kirill.sportsman.app.validation.UserValidationServiceImpl;
...
public class UserServiceImpl implements UserService {
    ...
    private final UserValidationServiceImpl validator;
    ...
    private User findOneOrThrowException(Long id) {
